...
public class Enemy6 : LivingEntity  //Enemy is a LivingEntity so it inherits all LivingEntity functions
{
    [Header("Public")]
...
/*                    else
                ...
                if (playerDetected == true)
                {
                    ...
                    {
                        PlayAnimation("Enemy6_seek1", 0.25f);
                    ...
                    else
                    {
                        if (remainingDistance <= attack2Range)
                        {
                            if (currentState != State.Attack)
                            {
                                PlayAnimation("Enemy6_idle1", 0.2f);
                        ...
                        else
                        {
                            if (currentState != State.Attack)
                            {
                                PlayAnimation("Enemy6_idle1", 0.35f);
    ...
    {
        PlayAnimation("Enemy6_attack1", 0.1f);
        AudioSource.PlayClipAtPoint(attack1Sound, transform.position, 0.20f);
    ...
    {
        PlayAnimation("Enemy6_attack2", 0.1f);
    ...
    {
        GameObject web = Instantiate(attack2Area, attack2Muzzle.transform.position, attack2Muzzle.transform.rotation);
        web.GetComponent<Web>().damage = attack2Damage;
    }
}