...
public class Enemy3 : LivingEntity  //Enemy is a LivingEntity so it inherits all LivingEntity functions
{
    [Header("Public")]
...
/*                    else
                ...
                if (playerDetected == true)
                {
                    ...
                    {
                        PlayAnimation("Enemy3_seek1", 0.25f);
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if (currentState != State.Attack)
                            {
                                PlayAnimation("Enemy3_idle1", 0.25f);
    ...
    {
        PlayAnimation("Enemy3_attack1", 0.1f);
    ...
    {
        PlayAnimation("Enemy3_attack2", 0.1f);
    ...
    {
        GameObject tornado = Instantiate(attack2Area, attack2Muzzle.transform.position, attack2Muzzle.transform.rotation);
        tornado.GetComponent<Tornado>().damage = attack2Damage;
        Destroy(tornado, 6f);
    }
}
